...
<head>
	...
	<script>
		...
		function newDish(){
			...
			document.getElementById('new_dish_button').style.visibility='hidden'; 
		...
		function saveNewDish(){
			...
			userText = dish_name.replace(/^\s+/, '').replace(/\s+$/, '');
			if (userText == "")  
			  {   
				...
				userText = dish_price.replace(/^\s+/, '').replace(/\s+$/, '');
				if (userText == "")  
				  {   
					 alert("please enter a dish price");        
				  }   
				else{
					$.ajax({
	...
	function loadDish(id){
		...
		document.getElementById('new_dish_button').style.visibility='visible'; 
		dish = dishArray[id];
		...
		document.getElementById('friday').value = dish[8];
		document.getElementById('saturday').value = dish[9];
		document.getElementById('sunday').value = dish[10];
									...
									<section>
										...
										<div class="form has-validation">
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" id="dish_price" name="name" required="required" onkeypress="return isNumberKey(event)" /></div>

											</div>
											
											<div class="clearfix">

												<label for="form-name" class="form-label">Image Link<small>Please provide the link to image</small></label>
											...
											<div class="clearfix">
												...
												<label for="form-name" class="form-label">Description<small>Please provide a description of the dish</small></label>
											...
											<div class="clearfix">
                                                ...
                                                <div class="form-input">
													<input type="text" class="onlyNumbers" id="monday" style="width:50px; margin-right:5px" />Monday<br>
													<input type="text" class="onlyNumbers" id="tuesday" style="width:50px; margin-right:5px" />Tuesday<br>
													<input type="text" class="onlyNumbers" id="wednesday" style="width:50px; margin-right:5px" />Wednesday<br>
													<input type="text" class="onlyNumbers" id="thursday" style="width:50px; margin-right:5px" />Thursday<br>
													<input type="text" class="onlyNumbers" id="friday" style="width:50px; margin-right:5px" />Friday<br>
													<input type="text" class="onlyNumbers" id="saturday" style="width:50px; margin-right:5px" />Saturday<br>
													<input type="text" class="onlyNumbers" id="sunday" style="width:50px; margin-right:5px" />Sunday<br>											
											...
											<div >
												...
												<button class="button" id="new_dish_button" onclick="newDish()" style="float:right; visibility:hidden" >New Dish</button>
