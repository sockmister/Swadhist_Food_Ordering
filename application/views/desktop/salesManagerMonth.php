								...
								<div id="orderArea1">
									...
									<table class="display" id="queuetable"> 
										...
										<tbody> 
											...
											<tr class="gradeA even" onclick="window.location='<?=site_url("stall_owner/daySales/".$dataitem->year."/".$dataitem->month."/".$dataitem->date)?>'"> 
												<td class=" sorting_1" style="text-align:center"><?=$dataitem->year?></td> 
												<td  style="text-align:center"><?=$month?></td> 
												<td  style="text-align:center"><?=$dataitem->date?></td> 
