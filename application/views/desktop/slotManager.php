									...
									<section>
										...
										<form class="form has-validation">
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_0" name="name" required="required" value=""/></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_1" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_2" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_3" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_4" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_5" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_6" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_7" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_8" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_9" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_10" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_11" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_12" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_13" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_14" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_15" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_16" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_17" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_18" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_19" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_20" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_21" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_22" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_23" name="name" required="required" /></div>
                                    ...
                                    <section>
                                        ...
                                        <form class="form has-validation">
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_24" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_25" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_26" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_27" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_28" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_29" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_30" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_31" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_32" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_33" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_34" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_35" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_36" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_37" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_38" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_39" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_40" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_41" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_42" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_43" name="name" required="required" /></div>
                                           ...
                                           <div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_44" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_45" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_46" name="name" required="required" /></div>
											...
											<div class="clearfix">
												...
												<div class="form-input"><input type="text" class="onlyNumbers" id="slot_47" name="name" required="required" /></div>
