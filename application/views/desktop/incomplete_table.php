...
<table class="display" id="incompletetable"> 
	<thead> 
<tr>
	...
	<tbody> 
		...
		<?php 
		foreach ($Incomplete as $dataitem){?>
		...
		<tr class="gradeA even"> 
			...
			<td class="center"><input type="button" value="Blacklist" onclick="sendToBlacklist('<?=$dataitem->id?>', '<?=$dataitem->user_id?>')"></td>	
			<td class="center"><input type="button" value="Resolve" onclick="sendToResolve('<?=$dataitem->id?>')"></td>		
		</tr>
