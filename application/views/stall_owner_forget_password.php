...
<title>Stall Owner Forget Password</title>
    ...
    <div class="login-box main-content">
      ...
      <header>
          ...
          <ul class="action-buttons clearfix">
              ...
              <li><a href="<?php echo site_url("stall_owner/getStallOrder")?>" class="button" data-icon-primary="ui-icon-info">Back to Login</a></li>
