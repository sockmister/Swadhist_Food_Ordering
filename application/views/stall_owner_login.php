    ...
    <div class="login-box main-content">
      ...
      <header>
          ...
          <ul class="action-buttons clearfix">
              ...
              <li><a href="<?php echo site_url("stall_owner_signup/register")?>" class="button" data-icon-primary="ui-icon-info">Register</a></li>

              <li><a href="<?php echo site_url("stall_owner_forget_password/forget_password")?>" class="button" data-icon-primary="ui-icon-help">Forgot Password</a></li>
